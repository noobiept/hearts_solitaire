...
var manifest = [
        ...
        { id: '2_of_clubs', src: G.BASE_URL + 'images/2_of_clubs.png' },
        { id: '3_of_clubs', src: G.BASE_URL + 'images/3_of_clubs.png' },
        { id: '4_of_clubs', src: G.BASE_URL + 'images/4_of_clubs.png' },
        { id: '5_of_clubs', src: G.BASE_URL + 'images/5_of_clubs.png' },
        { id: '6_of_clubs', src: G.BASE_URL + 'images/6_of_clubs.png' },
        { id: '7_of_clubs', src: G.BASE_URL + 'images/7_of_clubs.png' },
        { id: '8_of_clubs', src: G.BASE_URL + 'images/8_of_clubs.png' },
        { id: '9_of_clubs', src: G.BASE_URL + 'images/9_of_clubs.png' },
        { id: '10_of_clubs', src: G.BASE_URL + 'images/10_of_clubs.png' },
        ...
        { id: '2_of_diamonds', src: G.BASE_URL + 'images/2_of_diamonds.png' },
        { id: '3_of_diamonds', src: G.BASE_URL + 'images/3_of_diamonds.png' },
        { id: '4_of_diamonds', src: G.BASE_URL + 'images/4_of_diamonds.png' },
        { id: '5_of_diamonds', src: G.BASE_URL + 'images/5_of_diamonds.png' },
        { id: '6_of_diamonds', src: G.BASE_URL + 'images/6_of_diamonds.png' },
        { id: '7_of_diamonds', src: G.BASE_URL + 'images/7_of_diamonds.png' },
        { id: '8_of_diamonds', src: G.BASE_URL + 'images/8_of_diamonds.png' },
        { id: '9_of_diamonds', src: G.BASE_URL + 'images/9_of_diamonds.png' },
        { id: '10_of_diamonds', src: G.BASE_URL + 'images/10_of_diamonds.png' },
        ...
        { id: '2_of_spades', src: G.BASE_URL + 'images/2_of_spades.png' },
        { id: '3_of_spades', src: G.BASE_URL + 'images/3_of_spades.png' },
        { id: '4_of_spades', src: G.BASE_URL + 'images/4_of_spades.png' },
        { id: '5_of_spades', src: G.BASE_URL + 'images/5_of_spades.png' },
        { id: '6_of_spades', src: G.BASE_URL + 'images/6_of_spades.png' },
        { id: '7_of_spades', src: G.BASE_URL + 'images/7_of_spades.png' },
        { id: '8_of_spades', src: G.BASE_URL + 'images/8_of_spades.png' },
        { id: '9_of_spades', src: G.BASE_URL + 'images/9_of_spades.png' },
        { id: '10_of_spades', src: G.BASE_URL + 'images/10_of_spades.png' },
        ...
        { id: '2_of_hearts', src: G.BASE_URL + 'images/2_of_hearts.png' },
        { id: '3_of_hearts', src: G.BASE_URL + 'images/3_of_hearts.png' },
        { id: '4_of_hearts', src: G.BASE_URL + 'images/4_of_hearts.png' },
        { id: '5_of_hearts', src: G.BASE_URL + 'images/5_of_hearts.png' },
        { id: '6_of_hearts', src: G.BASE_URL + 'images/6_of_hearts.png' },
        { id: '7_of_hearts', src: G.BASE_URL + 'images/7_of_hearts.png' },
        { id: '8_of_hearts', src: G.BASE_URL + 'images/8_of_hearts.png' },
        { id: '9_of_hearts', src: G.BASE_URL + 'images/9_of_hearts.png' },
        { id: '10_of_hearts', src: G.BASE_URL + 'images/10_of_hearts.png' },
